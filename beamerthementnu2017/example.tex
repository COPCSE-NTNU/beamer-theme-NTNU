...
\begin{frame}
  ...
  \begin{itemize}
      \item Include many tex files by name
...
\begin{frame}
  ...
  \begin{itemize}
      \item Using .bib file to store information
      \item Download bibtex format from online paper Databases
...
\begin{frame}
  ...
  \begin{itemize}
      \item ShareLatex
      \item JabRef
      \item Web of Knowldge, Google Scholar,...
      \item gnuplot
      \item Doxygen
      \item \detokenize{\newcommand{}}
